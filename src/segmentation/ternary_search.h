...
double calc_loss_function(double alpha,double beta,vector<Pattern> truthPool)
{
...
{
	double left_alpha = 0.05, right_alpha = 200;
	...
	for (int _ = 0; _ < 30; _++){
		...
		lf1 = calc_loss_function(alpha1,beta1,truthPool);
		lf2 = calc_loss_function(alpha2,beta1,truthPool);
		lf3 = calc_loss_function(alpha1,beta2,truthPool);
		lf4 = calc_loss_function(alpha2,beta2,truthPool);
